const query = [
  ...
  `INSERT INTO warehouse_products_movements (id, id_warehouse, id_product, movement_type, amount, date, is_future) VALUES (gen_random_uuid(), (SELECT id FROM warehouses WHERE name = 'Warehouse Block B'), (SELECT id FROM products WHERE name = 'Dish Towels'), 'import', 3, now(), false);`,
